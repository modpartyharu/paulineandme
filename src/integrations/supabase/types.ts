  ...
  public: {
    Tables: {
      ...
      buckets: {
        ...
        Relationships: [
          {
            foreignKeyName: "buckets_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
      ...
      events: {
        Row: {
          ...
          end_time: string
          id: string
          is_new_for_user1: boolean | null
          is_new_for_user2: boolean | null
      ...
      key_dates: {
        ...
        Relationships: [
          {
            foreignKeyName: "key_dates_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
            referencedRelation: "rooms"
            referencedColumns: ["id"]
      ...
      lists: {
        ...
        Relationships: [
          {
            foreignKeyName: "lists_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
            referencedRelation: "rooms"
            referencedColumns: ["id"]
      ...
      todos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "todos_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
            referencedRelation: "rooms"
            referencedColumns: ["id"]
